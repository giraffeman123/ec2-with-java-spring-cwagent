...
curl https://raw.githubusercontent.com/giraffeman123/ec2-with-java-spring-cwagent/main/tomcat-binary/apache-tomcat-10.1.25.zip --output apache-tomcat-10.1.25.zip
